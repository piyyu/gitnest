    ...
    >
      ...
      <div className="flex shrink-0 select-none z-50"
        ...
        <div className="ml-auto flex items-center gap-6 pr-4 shrink-0" style={{ fontSize: 10, color: "#555", letterSpacing: "0.12em", textTransform: "uppercase" }}>
          ...
          <Link href="/auth/signin" className="hover:text-white transition-colors">SIGN IN [C]</Link>
        </div>
      </div>
        ...
        >
          <div style={{ width: "100%", maxWidth: 440 }}>
            <div style={{ fontSize: 9, color: "#555", letterSpacing: "0.18em", textTransform: "uppercase", marginBottom: 20, display: "flex", gap: 12 }}>
              <span>E14</span><span style={{ color: "#2a2a2a" }}>·</span><span>NEW ACCOUNT FORM</span>
            </div>
            ...
            <div style={{ marginBottom: 1 }}>
              <div style={{ fontSize: 9, color: "#444", letterSpacing: "0.15em", textTransform: "uppercase", padding: "6px 0", borderTop: "1px solid #1e1e1e", borderBottom: "1px solid #1e1e1e" }}>E14 · NAME</div>
              <div style={{ display: "flex", border: "1px solid #222", borderTop: "none" }}>
                <span style={{ padding: "12px 12px", fontSize: 11, color: "#444", borderRight: "1px solid #1e1e1e", userSelect: "none" }}>ID</span>
                <input type="text" value={name} onChange={e => setName(e.target.value)} placeholder="Your Name" style={{ flex: 1, background: "transparent", border: "none", outline: "none", color: "#fff", fontSize: 13, padding: "12px", fontFamily: "monospace", cursor: "text" }} />
              </div>
            </div>

            {/* email */}
            <div style={{ marginBottom: 1 }}>
              <div style={{ fontSize: 9, color: "#444", letterSpacing: "0.15em", textTransform: "uppercase", padding: "6px 0", borderBottom: "1px solid #1e1e1e" }}>E15 · EMAIL</div>
              <div style={{ display: "flex", border: "1px solid #222", borderTop: "none" }}>
                <span style={{ padding: "12px 12px", fontSize: 11, color: "#444", borderRight: "1px solid #1e1e1e", userSelect: "none" }}>@</span>
                <input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="user@example.com" style={{ flex: 1, background: "transparent", border: "none", outline: "none", color: "#fff", fontSize: 13, padding: "12px", fontFamily: "monospace", cursor: "text" }} />
              </div>
            </div>

            {/* password */}
            <div style={{ marginBottom: 24 }}>
              <div style={{ fontSize: 9, color: "#444", letterSpacing: "0.15em", textTransform: "uppercase", padding: "6px 0", borderBottom: "1px solid #1e1e1e" }}>E16 · PASSWORD</div>
              <div style={{ display: "flex", border: "1px solid #222", borderTop: "none" }}>
                <span style={{ padding: "12px 12px", fontSize: 11, color: "#444", borderRight: "1px solid #1e1e1e", userSelect: "none" }}>**</span>
                <input type="password" value={password} onChange={e => setPassword(e.target.value)} placeholder="••••••••" style={{ flex: 1, background: "transparent", border: "none", outline: "none", color: "#fff", fontSize: 13, padding: "12px", fontFamily: "monospace", cursor: "text" }} />
              </div>
            </div>
            ...
            <div style={{ fontSize: 10, color: "#444", letterSpacing: "0.1em", textTransform: "uppercase", textAlign: "center" }}>
              HAVE AN ACCOUNT?{" "}
              <Link href="/auth/signin" style={{ color: "#00eaff", textDecoration: "none" }}>SIGN IN [C]</Link>
            </div>
          </div>
        </div>
      </div>
